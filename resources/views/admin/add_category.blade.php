                ...
                <div class="container-xxl">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-lg-12">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <form action="{{URL('/paperadmin/categories/add-category')}}" method="post" enctype="multipart/form-data">
										@csrf
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="cat_name" name="name" onkeyup="slugMaking()" class="form-control" value="{{ old('name') }}" required>
												
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Slug <span class="text text-danger">*</span></label>
                                                <input type="text" id="cat_slug" name="slug" class="form-control" readonly="readonly" required>
                                            </div>
