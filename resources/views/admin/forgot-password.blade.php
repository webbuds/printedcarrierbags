...
<head>
    ...
    <title>Forgot Password | Paper Carrier Bags </title>
                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                            <div style="max-width: 25rem;">
                                ...
                                <!-- Image block -->
                                <div class="">
                                    <img src="{{asset('public/admin/assets/images/login-img.svg')}}" alt="login-img">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                ...
                                <form class="row g-1 p-3 p-md-4">
                                    <div class="col-12 text-center mb-5">
                                        <img src="{{asset('public/admin/assets/images/forgot-password.svg')}}" class="w240 mb-4" alt="" />
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <span class="text-muted"><a href="{{URL('/admin')}}" class="text-secondary">Back to Sign in</a></span>
                                    </div>
                                </form>
                                <!-- End Form -->
